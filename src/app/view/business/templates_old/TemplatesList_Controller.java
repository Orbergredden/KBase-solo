 ...
 */
public class TemplatesList_Controller implements AppItem_Interface {
    ...
    //
	TemplatesList_Controller.TreeView_Controller treeViewCtrl;
     ...
     */
    public TemplatesList_Controller () {
    	dateConv = new DateConv();
		prefs = Preferences.userNodeForPackage(TemplatesList_Controller.class);

		//treeViewCtrl = new TemplatesList_Controller().new TreeView_Controller();
...
//    	}
    	...
    	try {
			...
			Preferences prefs = Preferences.userNodeForPackage(TemplatesList_Controller.class);
